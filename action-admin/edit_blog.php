                ...
                <div class="col-lg-10 ">
                    ...
                    <div class="panel text-center">
                        ...
                        <div class="row">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                            <div class="text-center row"> 
                            <img src="../img/oren-home/blog/<?php echo $row['additional_image1']; ?>" height=100px width=100px>
                            <h3 class="panel-title"> Additional image <br> (please upload image size of 1280 X 720 px)</h3>
                            </div>
                            <button type="button" style="margin: 20px 0";  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal3" id="addimg">Change the Image</button>
                        </form>  
                            </div>
                            <div class="col-md-4 center">
                            <form action="" method="post" enctype="multipart/form-data">
                            <div class="text-center row"> 
                            <img src="../img/oren-home/blog/<?php echo $row['additional_image2']; ?>" height=100px width=100px>
                            <h3 class="panel-title"> Additional image <br> (please upload image size of 1280 X 720 px)</h3>
                            </div>
                            <button type="button" style="margin: 20px 0";  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal4" id="addimg">Change the Image</button>
                        </form>  
                            </div>
                        </div>
        ...
        <div class="modal fade" id="myModal3" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Change The Additional Image</h4>
                    </div>
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <label class="fg-label">Upload The Image</label>
...
if (isset($_POST['submit3'])) {
   ...
   $target_dir = "../img/oren-home/blog/";
    ...
    $sql = "UPDATE blog SET additional_image1 ='$image3' where id='$id'";
...
if (isset($_POST['submit4'])) {
   ...
   $target_dir = "../img/oren-home/blog/";
    ...
    $sql = "UPDATE blog SET additional_image2 ='$image4' where id='$id'";
