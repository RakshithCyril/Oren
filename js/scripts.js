...
$(function () {
    ...
    //         logo.attr('src', 'img/slid/Oren-Logo.png');
    ...
    //         logoChan.attr('src', 'img/slid/Oren-Logo.png');
    ...
    //         logoChan.attr('src', 'img/Oren-Logo.png');
...
function form(id){
    const lead_form = document.querySelector(`#form_display${id}`)
    lead_form.classList.toggle('lead_form')
}
